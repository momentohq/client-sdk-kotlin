...
class CacheClientListTest: BaseJvmTestClass() {
    ...
    @Test
    fun listConcatenateBackFailsWithInvalidListName() = runTest {
        val response = cacheClient.listConcatenateBack("cache", "", listOf())
        assert((response as ListConcatenateBackResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listConcatenateBackByteArrayFailsWithInvalidListName() = runTest {
        val response = cacheClient.listConcatenateBackByteArray("cache", "", listOf())
        assert((response as ListConcatenateBackResponse.Error).cause is InvalidArgumentException)
    }
    ...
    fun listConcatenateBackFetchStringHappyPath() = runTest {
        ...
        val listName = "listConcatenateBackString"
    ...
    @Test
    fun listConcatenateFrontFailsWithInvalidListName() = runTest {
        val response = cacheClient.listConcatenateFront("cache", "", listOf())
        assert((response as ListConcatenateFrontResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listConcatenateFrontByteArrayFailsWithInvalidListName() = runTest {
        val response = cacheClient.listConcatenateFront("cache", "", listOf())
        assert((response as ListConcatenateFrontResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listFetchFailsWithInvalidListName() = runTest {
        val response = cacheClient.listFetch("cache", "")
        assert((response as ListFetchResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listLengthFailsWithInvalidListName() = runTest {
        val response = cacheClient.listLength("cache", "")
        assert((response as ListLengthResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listPushBackFailsWithInvalidListName() = runTest {
        val response = cacheClient.listPushBack("cache", "", "val".toByteArray())
        assert((response as ListPushBackResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listPushFrontFailsWithInvalidListName() = runTest {
        val response = cacheClient.listPushFront("cache", "", "val")
        assert((response as ListPushFrontResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listPopBackFailsWithInvalidListName() = runTest {
        val response = cacheClient.listPopBack("cache", "")
        assert((response as ListPopBackResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listPopFrontFailsWithInvalidListName() = runTest {
        val response = cacheClient.listPopFront("cache", "")
        assert((response as ListPopFrontResponse.Error).cause is InvalidArgumentException)
    }
    ...
    @Test
    fun listRemoveValueFailsWithInvalidListName() = runTest {
        val response = cacheClient.listRemoveValue("cache", "", "value")
    ...
    @Test
    fun listRetainFailsWithInvalidListName() = runTest {
        val response = cacheClient.listRetain("cache", "")
        assert((response as ListRetainResponse.Error).cause is InvalidArgumentException)
    }
