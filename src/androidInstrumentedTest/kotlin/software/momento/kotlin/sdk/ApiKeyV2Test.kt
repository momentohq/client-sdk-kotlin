...
open class ApiKeyV2Test {
    companion object {
        ...
        fun createClients() {
            ...
            val endpoint = arguments.getString("MomentoEndpoint")!!
            cacheName = arguments.getString("TestCacheName")!!

            credentialProvider = CredentialProvider.fromApiKeyV2(apiKey, endpoint)
            ...
            topicClient = TopicClient(
                credentialProvider = credentialProvider,
                configuration = TopicConfigurations.Mobile.latest
            )
